...
@logs_router.post("/daily", response_model=DailyLogSchema)
...
@logs_router.get("/daily", response_model=DailyLogSchema)
...
@logs_router.get("/trends", response_model = list[DailyLogSchema])
